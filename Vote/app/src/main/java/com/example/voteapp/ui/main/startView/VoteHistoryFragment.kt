...
class VoteHistoryFragment : Fragment() {
    ...
    private fun initView(view: View?) {
        ...
        val vote1 = Vote("drawable/daofront", MyLocation(MyLocation.Areas.CITY, "Satoshi"), "We propose the creation of a Decentralized Autonomous Organization (DAO) to serve as a platform for community governance. The DAO will be governed by the community members and will enable decentralized decision-making, execution, and management of community projects and initiatives.",
            false, LocalDateTime.of(2021,4,5,11,24), User("drawable/man_icon","CBN", "DAO"), "DAO Summary"
        );
