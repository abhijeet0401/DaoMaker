...
class ProfileVotesFragment : Fragment() {
    ...
    private fun initView(view: View?) {
        ...
        val vote1 = Vote("drawable/dog_icon", MyLocation(MyLocation.Areas.CITY, "Satoshi Nakamoto"), "We propose the creation of a Decentralized Autonomous Organization (DAO) to serve as a platform for community governance. The DAO will be governed by the community members and will enable decentralized decision-making, execution, and management of community projects and initiatives.",
            true, LocalDateTime.of(2021,3,5,11,24), User("drawable/man_icon","Nagy Jóska", "polgármester"), "Decentralized Autonomous Organization (DAO) for Community Governance"
        );
//
